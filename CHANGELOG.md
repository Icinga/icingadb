...
* When logging against journald, include errors in the log message as well as in the journald fields. icinga-go-library#126
...
* Improve the documentation, including new sections on container installation and operations. #939, #942, #948, #950, #951
...
A schema upgrade is available and must be applied.
Please follow the [upgrading documentation](doc/04-Upgrading.md#upgrading-to-icinga-db-v140).
