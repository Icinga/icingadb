...
func (dbw *DBWrapper) SqlFetchAllTx(tx DbTransaction, queryObserver prometheus.Observer, rowType interface{}, query string, args ...interface{}) (interface{}, error) {
	return dbw.sqlFetchAllInternal(tx, queryObserver, query, rowType, false, args...)
}
